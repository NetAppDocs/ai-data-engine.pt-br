...
AIDE v1.0.0 oferece suporte básico ao Metadata Engine em servidores de terceiro com hardware adquirido pelo cliente. Recursos completos do AIDE com funcionalidades de GPU exigem hardware NetApp DCN.
