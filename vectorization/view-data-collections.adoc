...
.Antes de começar
* Você precisa de privilégios de _administrador de storage_ no ONTAP System Manager ou de _engenheiro de dados_ ou _cientista de dados_ no AI Data Engine Console (`\https://<cluster_management_ip>/console` para visualizar coleções de dados.
