...
.Antes de começar
* Você precisa de privilégios de _administrador de armazenamento_ no AI Data Engine Console (`\https://<cluster_management_ip>/console`) para criar e gerenciar políticas globais.
...
* link:../vectorization/view-data-collections.html["Visualizar coleções de dados no AI Data Engine"]
* link:../vectorization/zero-to-rag.html["Início rápido Data-to-RAG para AI Data Engine"]
