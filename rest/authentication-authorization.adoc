...
engenheiro de dados:: Esta é uma função administrativa ONTAP predefinida para o AIDE Data Engineer. Ela restringe o acesso apenas aos endpoints, bem como aos diretórios de comandos da CLI correspondentes, necessários para executar tarefas de engenharia de dados do AIDE, incluindo trabalhar com workspaces e data collections, visualizar jobs e usar a pré-visualização de arquivos quando permitido.
